...
public class Constants {
	...
	public static final String LOG_TAG = "MemoryTrainer";
	public static final String LOG_TAG_PERF = "MemoryTrainerPerf";
	...
	public static final String FLURRY_EVENTID_MAINTAIN_LIST_EDIT_ITEM_SAVE = "list item saved";
	public static final String FLURRY_ERRORID_MAINTAIN_LIST_DOWNLOAD_ERROR = "list item saved";
	...
	public static final String FLURRY_EVENTID_INFORMATION_WIKIPEDIA_LINK = "help: wikipedia clicked";
	
	public static final String FLURRY_EVENTID_ABOUT_WIKIPEDIA_LINK = "about: wikipedia clicked";
}
